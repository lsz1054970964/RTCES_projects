...
void deferrable_server_implementation(void *v_params) {
  ...
  for (;;) {
    ...
    /* Subtask 2: Complete the deferrable server
     ...
     * execution time of the deferrable server).
     *
     ...
     *    -> there are no remaining aperiodic tasks and the deferrable
     *       server yields its execution time
     *    -> the deferrable server completed an aperiodic task
